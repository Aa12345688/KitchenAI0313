                ...
                {ingredients.map((ingredient, index) => (
                    ...
                    >
                        <div className="flex-shrink-0">
                            {checkedItems[index] ? (
                                <div className="w-6 h-6 rounded-lg bg-[var(--primary)] flex items-center justify-center shadow-[0_0_10px_rgba(0,255,136,0.3)]">
                                    <CheckCircle2 size={16} className="text-[var(--background)]" strokeWidth={3} />
                                </div>
                            ) : (
                                <div className="w-6 h-6 rounded-lg border-2 border-white/10 group-hover:border-[var(--primary)]/50 transition-colors" />
                            )}
                        </div>
